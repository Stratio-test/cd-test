...
with
  ...
  modifications as (
    ...
    from tables_to_migrate
    union
    select "SERDE_ID", 'stratiossccdriver' as "PARAM_KEY", 'com.stratio.connectors.ssccadls2.ADLS2DriverOAuth2' as "PARAM_VALUE"
    from tables_to_migrate
    union
...
where ("PARAM_KEY" = 'stratiosecurity' and "PARAM_VALUE" ='true') or
      ...
      ("PARAM_KEY" = 'stratiossccdriver' and "PARAM_VALUE" ='com.stratio.connectors.ssccadls2.ADLS2DriverOAuth2') or
