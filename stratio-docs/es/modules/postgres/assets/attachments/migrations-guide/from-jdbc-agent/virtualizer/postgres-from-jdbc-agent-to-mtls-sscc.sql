-- Migrate jdbc agent to sscc connector using mtls authentication
...
with
  ...
  modifications as (
  	...
  	union
  	select "SERDE_ID", 'stratiossccdriver' as "PARAM_KEY", 'com.stratio.connectors.ssccpostgresql.PostgreSQLDriverTLS' as "PARAM_VALUE"
  	from tables_to_migrate
  	union
...
where ("PARAM_KEY" = 'stratiosecuritymode' and "PARAM_VALUE" ='custom_sscc') or
      ("PARAM_KEY" = 'stratiossccdriver' and "PARAM_VALUE" ='com.stratio.connectors.ssccpostgresql.PostgreSQLDriverTLS') or
