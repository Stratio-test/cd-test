...
hose {
    ...
    DEV = { config ->
        ...
        doSemgrepAnalysis(conf: config, configs: ["/semgrep-rules/rules/python-rules.json"], includes: ["*.py", "*.json", "testsAT"], buildToolOverride: [BUIDLTOOL_IMAGE: 'maven:3.8.5-openjdk-11'])
